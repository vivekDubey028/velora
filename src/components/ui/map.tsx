...
export function WorldMap({
  ...
  // Safe useTheme for environments where provider might be missing
  let themeObj;
  try {
    themeObj = useTheme();
  } catch (e) {
    // Falls back to light if context is unavailable
    themeObj = { theme: 'light' };
  }
  const theme = themeObj?.theme || 'light';
  ...
  return (
    <div className="w-full h-full dark:bg-black bg-white relative font-sans overflow-hidden">
      <img
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className={`text-[10px] font-medium px-1.5 py-0.5 rounded-md bg-white/95 dark:bg-black/95 text-black dark:text-white border border-gray-200 dark:border-gray-700 shadow-sm ${labelClassName}`}>
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
